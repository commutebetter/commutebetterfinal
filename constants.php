...
$paystack = "sk_test_18f0e582d711f0a74264367dc0fb4ed01f9d8aa6"; //Do not change this! Redirect URL http://localhost/train/pro/verify.php
...
function getTotalBookByType($id)
{
    ...
    $con2 =  connect()->query("SELECT SUM(no) as no FROM `booked` WHERE schedule_id = '$id'")->fetch_assoc();
    $no = $con['no'];
    $no2 = $con2['no'];
