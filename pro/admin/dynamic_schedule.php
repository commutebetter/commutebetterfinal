                            ...
                            <table id="example1" style="align-items: stretch;"
                                ...
                                <tbody>
                                    ...
                                    while ($fetch = $row->fetch_assoc()) {
                                        ...
                                        <td>Ugx <?php echo ($fetch['first_fee']); ?></td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="" method="post">
                                                        ...
                                                        <p>Taxi : <select class="form-control" name="train_id" required
                                                                id="">
                                                        ...
                                                        <p>
                                                            Taxi Charge : <input class="form-control"
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            Taxi : <select class="form-control" name="train_id" required id="">
                                <option value="">Select Taxi</option>
                                <?php
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            Taxi Charge : <input class="form-control" type="number" name="first_fee" required
                                id="">
                        </div>
...
if (isset($_POST['del_taxi'])) {
    $con = connect();
    $conn = $con->query("DELETE FROM schedule WHERE id = '" . $_POST['del_taxi'] . "'");
    if ($con->affected_rows < 1) {
        alert("Schedule Could Not Be Deleted. This Route Is Tied To Other Data!");
        load($_SERVER['PHP_SELF'] . "$me");
    } else {
